  ...
  return (
    <div className="p-4 md:p-6 lg:p-8">
      <div className="mb-6 flex items-start gap-3">
        ...
        <div>
          <h1 className="font-heading text-2xl font-bold text-gray-900 dark:text-white">Agenda Konseling</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">Jadwal sesi konseling, permohonan, dan pemanggilan mendatang.</p>
        </div>
      </div>
