        ...
        <RevealCard key={item.id}>
          ...
          >
            ...
            <div className="flex flex-col flex-1 p-5">
              ...
              <h3 className="mt-1.5 line-clamp-2 font-bold text-slate-900 dark:text-white transition-colors group-hover:text-amber-600 dark:group-hover:text-amber-400">
                {item.title}
              </h3>
