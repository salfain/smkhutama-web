      ...
      {news.map((item) => (
        <RevealCard key={item.id}>
          <Link
            ...
            className="group flex flex-col overflow-hidden rounded-3xl border border-hairline bg-surface shadow-sm transition-all hover:-translate-y-1.5 hover:shadow-xl h-full"
          >
            {item.imageUrl ? (
              ...
              <div className="flex h-48 w-full items-center justify-center bg-gradient-to-br from-anchor-soft to-anchor">
            ...
            <div className="flex flex-col flex-1 p-5">
              ...
              <p className="mt-2 line-clamp-3 text-sm leading-relaxed text-ink-soft flex-1">
                {item.excerpt}
              </p>
              <span className="mt-4 inline-flex items-center gap-1 text-xs font-semibold text-brand-text">
